...
public class MainAppLayout extends AppLayout {
    ...
    private void createDrawer() {
        ...
        SideNavItem namesEditor = new SideNavItem("Редактор имен пользователей", NamesEditorView.class, VaadinIcon.USER_CARD.create());
        SideNavItem h2Admin = new SideNavItem("Админка H2DB", H2dbAdminView.class, VaadinIcon.DATABASE.create());

        SideNav nav = new SideNav();
        nav.addItem(main, liftState, usersOnline, liftRides, namesEditor, h2Admin);
        addToDrawer(nav);
    }
